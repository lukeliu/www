		...
		extm: function extm(userOptions) {
			...
			function extmInit(options, imageElement) {
				...
				if (options.squareOverlay) {
					overlayElement = $( "<div id='oElement' class='overlayElement' style='pointer-events:none;height:"+smallHeight+"px;width:"+smallWidth+"px;position:absolute;top:"+offset.top+"px;left:"+offset.left+"px;'></div>" );
